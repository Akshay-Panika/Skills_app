    ...
    return Scaffold(
      ...
      body: Obx(() {
        final isLoading = _categoryController.isLoading.value ||
            !_locationController.isLocationLoaded.value;
        ...
        return CustomScrollView(
          ...
          slivers: [
            ...
            SliverPersistentHeader(
             ...
             SliverToBoxAdapter(
              child: Obx(() {
                // if (_serviceListController.isLoading.value) return const SizedBox();
                ...
                if (nearby.isEmpty) {
                  return Padding(
                    padding: EdgeInsets.only(
                      top: _categoryController.categoryList.isNotEmpty ? 20 : 100,
                    ),
